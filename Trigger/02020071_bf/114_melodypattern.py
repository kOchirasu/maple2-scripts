""" trigger/02020071_bf/114_melodypattern.xml """
import trigger_api
...
class MelodyPlay01_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11205], visible=True) # Bell F
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_blue') # Bell F
...
class MelodyPlay01_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11203], visible=True) # Bell D
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_yellow') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11205], visible=True) # Bell A
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_blue') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11203], visible=True) # Bell B
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_yellow') # Bell B
...
class MelodyPlay04_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11202], visible=True) # Bell HighC
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_orange') # Bell HighC
...
class MelodyPlay05_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell HighC
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000062], state=1) # Lever F
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000060], state=1) # Lever D
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000062], state=1) # Lever A
...
class CheckAnswer05_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000059], state=1) # Lever B
