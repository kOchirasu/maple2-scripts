""" trigger/02020071_bf/106_melodypattern.xml """
import trigger_api
...
class MelodyPlay01_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11202], visible=True) # Bell F
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_orange') # Bell F
...
class MelodyPlay01_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11204], visible=True) # Bell A
        self.set_actor(trigger_id=11004, visible=True, initial_sequence='ks_quest_musical_B01_green') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11004, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell A
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000059], state=1) # Lever F
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000061], state=1) # Lever A
