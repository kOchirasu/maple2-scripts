""" trigger/02020071_bf/102_melodypattern.xml """
import trigger_api
...
class MelodyPlay01_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11201], visible=True) # Bell F
        self.set_actor(trigger_id=11001, visible=True, initial_sequence='ks_quest_musical_B01_red') # Bell F
...
class MelodyPlay01_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11001, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11202], visible=True) # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11203], visible=True) # Bell A
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_yellow') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11003, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11208], visible=True) # Bell B
        self.set_actor(trigger_id=11008, visible=True, initial_sequence='ks_quest_musical_B01_pink') # Bell B
...
class MelodyPlay04_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11008, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_yellow') # Bell HighC
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000058], state=1) # Lever F
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000060], state=1) # Lever A
...
class CheckAnswer04_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000065], state=1) # Lever B
