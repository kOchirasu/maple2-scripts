...
class RightItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=3107, script='$02000387_BF__3107_CUSTOMER__0$', time=3)
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawn_id=3107)
        self.set_dialogue(type=1, spawn_id=3107, script='$02000387_BF__3107_CUSTOMER__1$', time=3)
