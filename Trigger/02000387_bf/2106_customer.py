...
class CustomerEnter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[2106], auto_target=False)
...
class Patrol01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2106, patrol_name='MS2PatrolData_201')
...
class Patrol02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2106, patrol_name='MS2PatrolData_202')
...
class Patrol03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2106, patrol_name='MS2PatrolData_203')
...
class PatrolEnd(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9123, spawn_ids=[2106]):
            # 카운터 앞에 도착했으면
...
class PickItem_30000703(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2106, nif_path='Map/Steampunk/Field/sp_fi_prop_anvil_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000704(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2106, nif_path='Map/Steampunk/Field/sp_fi_prop_bellows_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000705(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2106, nif_path='Map/Steampunk/Field/sp_fi_prop_brazier_C01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000715(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2106, nif_path='Map/Steampunk/Field/sp_fi_prop_brazier_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class CustomerLeave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2106, patrol_name='MS2PatrolData_222')

    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9302, spawn_ids=[2106]):
            return Quit(self.ctx)


class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.destroy_monster(spawn_ids=[2106])
