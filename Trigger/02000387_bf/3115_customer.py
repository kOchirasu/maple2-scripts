...
class CustomerEnter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[3115], auto_target=False)
...
class Patrol01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=3115, patrol_name='MS2PatrolData_301')
...
class Patrol02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=3115, patrol_name='MS2PatrolData_302')
...
class Patrol03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=3115, patrol_name='MS2PatrolData_303')
...
class PatrolEnd(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9133, spawn_ids=[3115]):
            # 카운터 앞에 도착했으면
...
class PickItem_30000617(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Common/Field/co_fi_prop_game_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000618(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Common/Field/co_fi_prop_game_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000668(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_cranegame_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000671(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_photosticker_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000672(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_pingpong_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000673(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_pooltable_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000674(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_pump_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000676(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=3115, nif_path='Map/Royalcity/Indoor/ry_in_prop_soccertable_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class CustomerLeave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=3115, patrol_name='MS2PatrolData_333')

    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9303, spawn_ids=[3115]):
            return Quit(self.ctx)


class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.destroy_monster(spawn_ids=[3115])
