""" trigger/02000387_bf/2010_customer.xml """
import trigger_api
...
class Patrol01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2010, patrol_name='MS2PatrolData_201')
...
class Patrol02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2010, patrol_name='MS2PatrolData_202')
...
class Patrol03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2010, patrol_name='MS2PatrolData_203')
...
class PatrolEnd(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9123, spawn_ids=[2010]):
            # 카운터 앞에 도착했으면
...
class PickItem_30000617(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Field/co_fi_prop_game_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000618(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Field/co_fi_prop_game_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000619(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Field/co_fi_prop_lamp_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000620(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Henesys/Indoor/he_in_prop_fireplace_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000621(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_sandbag_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000622(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Iceland/Indoor/ic_in_prop_snowball_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000623(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_bath_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000624(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_bath_C01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000625(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_shower_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000626(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_fridge_C02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000627(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_fridge_D03.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000628(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_display_C01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000629(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_fridge_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000630(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_display_C02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000631(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_washstand_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000632(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_sink_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000633(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_sink_A03.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000634(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_tv_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000635(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_tv_C01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000636(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_toilet_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000637(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_washer_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000638(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_fan_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000639(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_machine_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000640(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_cutter_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000641(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Henesys/Indoor/he_in_prop_kettle_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000642(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_locker_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000643(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_locker_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000644(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Iceland/Indoor/ic_in_cubric_box_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000645(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Field/tr_fi_prop_swing_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000646(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/UGC/Indoor/ugc_in_funct_cook_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000647(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/UGC/Indoor/ugc_in_funct_alchemy_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000648(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/UGC/Indoor/ugc_in_funct_alchemy_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000649(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_mirror_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000650(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_easel_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000651(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_wardrop_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000652(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Indoor/co_in_prop_brazier_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000653(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_tray_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000654(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_sofa_E01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000655(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000656(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/SF/Indoor/sf_in_prop_bed_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000657(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Iceland/Indoor/ic_in_prop_bed_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000658(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_ringer_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000659(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Indoor/co_in_prop_guestbook_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000660(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_display_B02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000661(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_cubric_fishtank_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000662(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_basketball_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000663(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_running_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000664(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_trampoline_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000665(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_baseballcart_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000666(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_basketball_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000667(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_handball_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000668(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_cranegame_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000669(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_chandelier_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000670(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_goalpost_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000671(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_photosticker_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000672(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_pingpong_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000673(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_pooltable_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000674(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_pump_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000675(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_sewingmachine_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000676(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_soccertable_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000677(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Field/ry_fi_prop_plane_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000678(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Field/ry_fi_prop_hammock_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000679(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Field/ry_fi_prop_yacht_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000680(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_grill_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000681(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Orient/Field/or_fi_prop_seesaw_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000682(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_display_E01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000683(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Orient/Field/or_fi_prop_ship_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000684(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Ludibrium/Field/lu_fi_prop_rocket_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000685(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Lith/Field/li_fi_prop_anchor_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000686(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Lith/Field/li_fi_prop_tube_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000687(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_beanbag_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000688(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_surgerylamp_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000689(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_surgery_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000690(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_sofa_D01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000691(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_paintbag_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000692(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_dresser_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000693(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_massage_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000694(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Indoor/ke_in_prop_catower_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000695(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Npc/Etc/UGC_SportsCar_Npc/UGC_SportsCar_Npc_02.nif', is_outline=True, scale=1.2, rotate_z=315)
...
class PickItem_30000696(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Npc/Etc/UGC_F1RacingCar/UGC_F1RacingCar_01.nif', is_outline=True, scale=1.2, rotate_z=315)
...
class PickItem_30000697(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Npc/Etc/UGC_Poclain/UGC_Poclain_01.nif', is_outline=True, scale=1.2, rotate_z=315)
...
class PickItem_30000698(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Npc/Etc/UGC_FlameBike_Npc/UGC_FlameBike_03.nif', is_outline=True, scale=1.2, rotate_z=315)
...
class PickItem_30000699(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Field/co_fi_prop_tent_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000700(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Royalcity/Indoor/ry_in_prop_djtable_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000701(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Indoor/co_in_prop_security_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000702(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Tria/Indoor/tr_in_prop_workit_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000703(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Steampunk/Field/sp_fi_prop_anvil_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000704(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Steampunk/Field/sp_fi_prop_bellows_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000705(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Steampunk/Field/sp_fi_prop_brazier_C01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000706(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Indoor/co_in_prop_icebox_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000707(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Henesys/Indoor/he_in_prop_cushiona_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000708(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Effect/BG/Liftup/co_liftup_piano_B01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000709(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Effect/BG/Liftup/co_liftup_vibraphone_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000710(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Common/Indoor/co_in_prop_camera_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000711(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/UGC/Indoor/ugc_in_funct_workstone_G01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000712(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Orient/Indoor/or_in_prop_incense_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000713(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Steampunk/Indoor/sp_in_prop_desk_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000714(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/SF/Field/sf_fi_prop_incubator_D01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000715(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Steampunk/Field/sp_fi_prop_brazier_A01.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class PickItem_30000716(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawn_id=2010, nif_path='Map/Kerningcity/Field/ke_fi_prop_tire_A02.nif', is_outline=True, scale=1.2, rotate_z=225)
...
class RightItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawn_id=2010)
        self.set_dialogue(type=1, spawn_id=2010, script='$02000387_BF__2010_CUSTOMER__0$', time=3)
...
class CustomerLeave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=2010, patrol_name='MS2PatrolData_222')

    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=9302, spawn_ids=[2010]):
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawn_id=2010)
        self.set_dialogue(type=1, spawn_id=2010, script='$02000387_BF__2010_CUSTOMER__1$', time=3)
