""" trigger/52000030_qd/main_b.xml """
import trigger_api
...
class 이슈라대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000030_QD__MAIN_B__0$', time=3)
        self.set_dialogue(type=2, spawn_id=11001583, script='$52000030_QD__MAIN_B__1$', time=3)
...
class 이슈라대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000030_QD__MAIN_B__2$', time=2)
...
class 이슈라대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000030_QD__MAIN_B__3$', time=3)
