...
class 라운드1시작전UI(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__0$', duration=3000)

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=4000):
            self.lock_my_pc(is_lock=True)
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__1$', duration=6000)
...
class 라운드1진행(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.widget_value(type='TypingGame', name='Result') == 1:
            ...
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__2$', duration=3000)
        ...
        if self.widget_value(type='TypingGame', name='Result') == 0:
            ...
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__3$', duration=3000)
            return 라운드종료(self.ctx)


class 라운드2시작전UI(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__4$', duration=3000)

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=4000):
            self.lock_my_pc(is_lock=True)
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__5$', duration=4000)
...
class 라운드2진행(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.widget_value(type='TypingGame', name='Result') == 1:
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__6$', duration=3000)
            self.widget_action(type='Round', func='RoundResult', widget_arg='1')
            return 라운드종료(self.ctx)
        if self.widget_value(type='TypingGame', name='Result') == 0:
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__7$', duration=3000)
            self.widget_action(type='Round', func='RoundResult', widget_arg='0')
            return 라운드종료(self.ctx)
...
class 라운드3시작전UI(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__8$', duration=3000)

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=4000):
            self.lock_my_pc(is_lock=True)
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__9$', duration=3000)
...
class 라운드3진행(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.widget_value(type='TypingGame', name='Result') == 1:
            self.lock_my_pc(is_lock=True)
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__10$', duration=3000)
            self.widget_action(type='Round', func='RoundResult', widget_arg='1')
            return 라운드종료(self.ctx)
        if self.widget_value(type='TypingGame', name='Result') == 0:
            self.set_event_ui_script(type=BannerType.Text, script='$02000533_BF__GAMELOGIC_9002__11$', duration=3000)
            self.widget_action(type='Round', func='RoundResult', widget_arg='0')
            return 라운드종료(self.ctx)
...
class 게임성공종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=9001, key='GameLogicEnd', value=1)
...
class 게임실패종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=9001, key='GameLogicEnd', value=2)
        self.set_user_value(key='GameLogicStart', value=999) # 코드는 테스트 후 지워주세요
