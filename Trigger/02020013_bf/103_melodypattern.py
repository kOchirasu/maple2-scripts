""" trigger/02020013_bf/103_melodypattern.xml """
import trigger_api
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11206], visible=True) # Bell D
        self.set_actor(trigger_id=11006, visible=True, initial_sequence='ks_quest_musical_B01_navy') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11006, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell D
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000063], state=1) # Lever D
