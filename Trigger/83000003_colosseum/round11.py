...
class 스폰대사(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.user_detected(box_ids=[904]):
            self.set_event_ui(type=1, arg2='$83000003_COLOSSEUM__ROUND11__7$', arg3='3000')
...
class ClearRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            ...
            self.set_event_ui(type=3, arg2='$83000003_COLOSSEUM__ROUND11__9$', arg3='3000')
...
class FailRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui(type=5, arg2='$83000003_COLOSSEUM__ROUND11__10$', arg3='3000')
            return FailRound(self.ctx)
