...
class 스폰대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='LimitTimer', seconds=120, start_delay=1)
...
class ClearRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            ...
            self.set_event_ui(type=3, arg2='$83000002_COLOSSEUM__ROUND5__8$', arg3='3000')
...
class FailRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui(type=5, arg2='$83000002_COLOSSEUM__ROUND5__9$', arg3='3000')
            return FailRound(self.ctx)
