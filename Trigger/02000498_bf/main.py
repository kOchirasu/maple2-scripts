...
class 시작연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='다크스크림의 새로운 차원의 틈으로 진입 했습니다.', duration=3000)
...
class 시작연출_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='더 가까이 다가가십시오.', duration=3000)
