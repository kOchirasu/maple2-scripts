...
class questIdle(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.quest_user_detected(box_ids=[701], quest_ids=[50100090], quest_states=[2]):
...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$52100013_QD__AI__7$', time=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52100013_QD__AI__0$', time=2)
