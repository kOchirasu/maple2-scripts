...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_user(map_id=52100013, portal_id=2)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100013_QD__MAIN__0$', time=2, arg5=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52100013_QD__MAIN__1$', time=2)
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100013_QD__MAIN__2$', time=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52100013_QD__MAIN__3$', time=2)
