...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10002101], state=0) # LeverForLadder01
        self.set_interact_object(trigger_ids=[10002102], state=0) # LeverForRope
        self.set_interact_object(trigger_ids=[10002103], state=0) # LeverForLadder02
...
class MobActorSpawn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=901, script='$52100055_QD__01_ABOVEWALL__0$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=902, script='$52100055_QD__01_ABOVEWALL__0$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=903, script='$52100055_QD__01_ABOVEWALL__0$', time=2, arg5=1)
...
class Battle01Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10002101], state=1) # LeverForLadder01

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002101], state=0):
...
class Battle03Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10002102], state=1) # LeverForRope

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002102], state=0):
...
class Battle04Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10002103], state=1) # LeverForLadder02

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002103], state=0):
