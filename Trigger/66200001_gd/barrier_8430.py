...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001199], state=2) # On
        self.set_interact_object(trigger_ids=[10001215], state=2) # Off
...
class Sensor7432(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8431,8432,8433,8434,8435,8436])
        self.set_effect(trigger_ids=[8430])
        self.set_interact_object(trigger_ids=[10001199], state=0) # On
        self.set_interact_object(trigger_ids=[10001215], state=0) # Off
...
class CheckSameUserTag7432(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430) == 2:
            return Enable7432(self.ctx)
        if self.count_users(box_id=9430) != 2:
            return Sensor7432(self.ctx)
        if not self.check_same_user_tag(box_id=9430):
            return SafeGreen7432(self.ctx)
        if self.user_value(key='Barrier43') == 10:
            return Reset(self.ctx)
...
class Enable7432(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001199], state=1) # On

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001199], state=0):
            # On
...
class Delay7432(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001215], state=1) # Off
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.user_value(key='Barrier43') == 10:
            return Reset(self.ctx)
        if self.object_interacted(interact_ids=[10001215], state=0):
            # Off
...
class CheckSameUserTag7433(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430) == 3:
...
class CheckSameUserTag7434(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430) == 4:
...
class CheckSameUserTag7435(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430) == 5:
