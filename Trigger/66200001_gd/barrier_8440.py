""" trigger/66200001_gd/barrier_8440.xml """
import trigger_api
...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001200], state=2) # On
        self.set_interact_object(trigger_ids=[10001216], state=2) # Off
...
class Sensor7442(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8441,8442,8443,8444])
        self.set_effect(trigger_ids=[8440])
        self.set_interact_object(trigger_ids=[10001200], state=0) # On
        self.set_interact_object(trigger_ids=[10001216], state=0) # Off
...
class SafeGreen7442(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440) == 2:
            return CheckSameUserTag7442(self.ctx)
        if self.count_users(box_id=9440) != 2:
            return Sensor7442(self.ctx)
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
...
class CheckSameUserTag7442(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440) == 2:
            return Enable7442(self.ctx)
        if self.count_users(box_id=9440) != 2:
            return Sensor7442(self.ctx)
        if not self.check_same_user_tag(box_id=9440):
            return SafeGreen7442(self.ctx)
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
...
class Enable7442(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001200], state=1) # On

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001200], state=0):
            # On
...
class Delay7442(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001216], state=1) # Off
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
        if self.object_interacted(interact_ids=[10001216], state=0):
            # Off
...
class SafeGreen7443(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440) == 3:
            return CheckSameUserTag7443(self.ctx)
        if self.count_users(box_id=9440) != 3:
            return Sensor7443(self.ctx)
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
...
class CheckSameUserTag7443(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440) == 3:
...
class SafeGreen7444(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440) == 4:
            return CheckSameUserTag7444(self.ctx)
        if self.count_users(box_id=9440) != 4:
            return Sensor7444(self.ctx)
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
...
class CheckSameUserTag7444(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440) == 4:
...
class SafeGreen7445(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440) == 5:
            return CheckSameUserTag7445(self.ctx)
        if self.count_users(box_id=9440) != 5:
            return Sensor7445(self.ctx)
        if self.user_value(key='Barrier44') == 10:
            return Reset(self.ctx)
...
class CheckSameUserTag7445(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440) == 5:
