...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001193], state=2) # On
        self.set_interact_object(trigger_ids=[10001209], state=2) # Off
...
class Sensor7312(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8311,8312,8313,8314,8315,8316])
        self.set_effect(trigger_ids=[8310])
        self.set_interact_object(trigger_ids=[10001193], state=0) # On
        self.set_interact_object(trigger_ids=[10001209], state=0) # Off
...
class CheckSameUserTag7312(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310) == 2:
            return Enable7312(self.ctx)
        if self.count_users(box_id=9310) != 2:
            return Sensor7312(self.ctx)
        if not self.check_same_user_tag(box_id=9310):
            return SafeGreen7312(self.ctx)
        if self.user_value(key='Barrier31') == 10:
            return Reset(self.ctx)
...
class Enable7312(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001193], state=1) # On

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001193], state=0):
            # On
...
class Delay7312(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001209], state=1) # Off
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.user_value(key='Barrier31') == 10:
            return Reset(self.ctx)
        if self.object_interacted(interact_ids=[10001209], state=0):
            # Off
...
class CheckSameUserTag7313(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310) == 3:
...
class CheckSameUserTag7314(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310) == 4:
...
class CheckSameUserTag7315(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310) == 5:
