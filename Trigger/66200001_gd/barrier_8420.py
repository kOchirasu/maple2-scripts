...
class CheckSameUserTag7422(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9420) and self.count_users(box_id=9420) == 2:
...
class CheckSameUserTag7423(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9420) and self.count_users(box_id=9420) == 3:
...
class CheckSameUserTag7424(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9420) and self.count_users(box_id=9420) == 4:
...
class CheckSameUserTag7425(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9420) and self.count_users(box_id=9420) == 5:
