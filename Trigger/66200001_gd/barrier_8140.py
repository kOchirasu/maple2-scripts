...
class CheckSameUserTag7142(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9140) and self.count_users(box_id=9140) == 2:
...
class CheckSameUserTag7143(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9140) and self.count_users(box_id=9140) == 3:
...
class CheckSameUserTag7144(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9140) and self.count_users(box_id=9140) == 4:
...
class CheckSameUserTag7145(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9140) and self.count_users(box_id=9140) == 5:
