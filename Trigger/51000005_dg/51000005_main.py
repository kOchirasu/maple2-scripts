...
class 게임시작_대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # lifeCount : 최대 사망 횟수
        self.arcade_three_two_one2_start_game(life_count=5, init_score=10000)
        ...
        self.add_balloon_talk(msg='$51000005_DG__51000005_MAIN__4$', duration=3000) # PC : 내가 이길 거야!
...
class 라운드시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.arcade_three_two_one2_start_round(ui_duration=4, round=1)
...
class 좌로돌아01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_result_round(result_direction=1)
...
class 뒤로돌아02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_result_round(result_direction=2)
...
class 우로돌아03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_result_round(result_direction=3)
...
class 결과연출(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='ThreeTwoOneResult') == 1:
            ...
            self.set_pc_emotion_loop(sequence_name='Emotion_Dance_X', duration=2450.0) # PC 신나서 인싸댄스
...
class 결과정산(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_result_round2(round=1)
...
class 라운드결과(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_clear_round(round=1)
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.arcade_three_two_one2_end_game()
