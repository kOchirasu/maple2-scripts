...
class start_game_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000345_BF__MAIN__11$', duration=3000)
...
class start_game_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000345_BF__MAIN__18$', duration=3000)
...
class 오브젝티브_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000345_BF__MAIN1__2$', duration=10000)
...
class 클리어(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Fail, script='$02000345_BF__MAIN1__1$', duration=3000)
