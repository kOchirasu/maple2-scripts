""" trigger/99999872/13000_minipuzzle_passingthroughring.xml """
import trigger_api
...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[12000068], state=2)
...
class PassingThroughRing_Success(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거
        self.set_interact_object(trigger_ids=[12000068], state=1)

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000068], state=0):
