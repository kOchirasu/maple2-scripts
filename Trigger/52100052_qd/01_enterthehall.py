...
class EnemyApp02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=901, script='$52100052_QD__01_ENTERTHEHALL__2$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=902, script='$52100052_QD__01_ENTERTHEHALL__2$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=903, script='$52100052_QD__01_ENTERTHEHALL__2$', time=2, arg5=1)
...
class BlackeyeAction01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001590, script='$52100052_QD__01_ENTERTHEHALL__5$', time=5) # 이슈라
...
class BlackeyeAction02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$52100052_QD__01_ENTERTHEHALL__6$', time=3, arg5=1)
...
class MoveToUpstairs02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001590, script='$52100052_QD__01_ENTERTHEHALL__7$', time=5) # 이슈라
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.set_event_ui_script(type=BannerType.Text, script='$52100052_QD__01_ENTERTHEHALL__8$', duration=4000, box_ids=['0'])
...
class NpcMonologue01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100052_QD__01_ENTERTHEHALL__9$', time=3) # 이슈라
...
class NpcMonologue02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100052_QD__01_ENTERTHEHALL__10$', time=3) # 이슈라
...
class NpcMonologue03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100052_QD__01_ENTERTHEHALL__11$', time=3) # 이슈라
...
class NpcMonologue04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$52100052_QD__01_ENTERTHEHALL__12$', time=3) # 이슈라
