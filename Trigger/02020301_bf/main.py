...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npc_id=23503003, illust='ArcheonBlack_Normal', script='$02020301_BF__MAIN__0$', duration=5684)
...
class 조건추가(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        """
        # all_of: 	<condition name="DungeonCheckPlayTime" playSeconds="420" operator="Less" />
...
class 보스전_성공(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dungeon_set_end_time()
        self.side_npc_talk(npc_id=23503003, illust='ArcheonBlack_Die', script='$02020301_BF__MAIN__1$', duration=3176)
...
class 추가대화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11004205, illust='ArcaneBlader_normal', script='$02020301_BF__MAIN__2$', duration=3176)
