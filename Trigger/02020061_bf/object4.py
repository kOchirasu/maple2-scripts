...
class 레버4_안내멘트(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020061_BF__OBJECT4__0$', duration=5000, box_ids='9014')
...
class 레버4_발동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020061_BF__OBJECT4__1$', duration=5000, box_ids='9014')
