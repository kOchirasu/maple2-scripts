...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[401,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416])
...
class 예고이펙트(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[4021])
        self.spawn_monster(spawn_ids=[4022])
        self.spawn_monster(spawn_ids=[4023])
        self.spawn_monster(spawn_ids=[4024])
        self.spawn_monster(spawn_ids=[4025])
        self.spawn_monster(spawn_ids=[4026])
        self.spawn_monster(spawn_ids=[4027])
        self.spawn_monster(spawn_ids=[4028])
