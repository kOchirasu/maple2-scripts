""" trigger/84000007_wd/color_7110.xml """
import trigger_api
...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[811], visible=True) # yellow
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[1011]) # red
...
class YellowBefore(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[811], visible=True, fade=2.0) # yellow
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[1011]) # red
...
class RedBefore(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[1011], visible=True) # red
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[811]) # yellow
...
class GreenAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[911], visible=True) # green
...
class YellowAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[811], visible=True, fade=2.0) # yellow
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[1011], start_delay=100) # red
...
class RedAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[1011], visible=True) # red
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[811], start_delay=100) # yellow
...
class Clear(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[911], fade=2.0) # green
        self.set_mesh(trigger_ids=[811], fade=2.0) # yellow
        self.set_mesh(trigger_ids=[1011], fade=2.0) # red
...
class Regen(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[811], visible=True, start_delay=400) # yellow
        self.set_mesh(trigger_ids=[911]) # green
        self.set_mesh(trigger_ids=[1011]) # red
