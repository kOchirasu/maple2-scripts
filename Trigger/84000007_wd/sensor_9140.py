""" trigger/84000007_wd/sensor_9140.xml """
import trigger_api
...
class Pass(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(trigger_id=7140, key='Color14', value=0) # color reset
...
class Fail(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(trigger_id=7140, key='Color14', value=4) # color clear
