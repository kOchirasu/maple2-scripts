""" trigger/84000007_wd/barrier_8240.xml """
import trigger_api
...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10000945], state=2) # On
        self.set_interact_object(trigger_ids=[10000961], state=2) # Off
...
class Sensor7242(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8241,8242,8243,8244,8245,8246])
        self.set_effect(trigger_ids=[8240])
        self.set_interact_object(trigger_ids=[10000945], state=0) # On
        self.set_interact_object(trigger_ids=[10000961], state=0) # Off
...
class Enable7242(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10000945], state=1) # On

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10000945], state=0):
            # On
...
class Delay7242(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10000961], state=1) # Off
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.user_value(key='Barrier24') == 10:
            return Reset(self.ctx)
        if self.object_interacted(interact_ids=[10000961], state=0):
            # Off
