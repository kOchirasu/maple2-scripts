...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[314,315,316,317,318,319,320])
...
class 사다리생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10000429], state=0)
        self.set_mesh(trigger_ids=[314,315,316,317,318,319,320], visible=True, interval=500)
