...
class 자베스대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001546, script='$52000050_QD__MAIN_03__0$', time=3)
...
class 브라보대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001545, script='$52000050_QD__MAIN_03__1$', time=3)
...
class 제이시대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000515, script='$52000050_QD__MAIN_03__2$', time=5)
