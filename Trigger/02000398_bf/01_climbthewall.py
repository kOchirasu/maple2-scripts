...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10001132], state=1) # Lever
        self.set_interact_object(trigger_ids=[10001133], state=1) # Lever
...
class TerraceMobAttack01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=901, script='$02000398_BF__01_CLIMBTHEWALL__0$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=902, script='$02000398_BF__01_CLIMBTHEWALL__1$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=903, script='$02000398_BF__01_CLIMBTHEWALL__2$', time=2, arg5=1)
...
class TowerUnderMobAttack01(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001132], state=0):
...
class GuidePullTheLever01(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001133], state=0):
