""" trigger/61000007_me/mainprocess_springbeach.xml """
import trigger_api
...
class 경기장입장(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        self.move_user(map_id=61000007, portal_id=902, box_id=302)
...
class 시작멘트1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.start_mini_game(box_id=301, round=5, game_name='springbeach')
...
class 보상단계(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.end_mini_game(winner_box_id=301, game_name='springbeach')
