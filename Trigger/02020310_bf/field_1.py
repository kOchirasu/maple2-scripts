...
class Block_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[1104,1150,1151,1152,1157,1158,1159,1160,1161]):
            self.side_npc_talk(npc_id=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__0$', duration=5000)
...
class Block_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[1105,1153,1154,1162,1163,1164,1165,1166]):
            self.side_npc_talk(npc_id=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__1$', duration=5000)
...
class Block_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[1106,1155,1156,1167,1168,1169,1170,1171,1172]):
            self.side_npc_talk(npc_id=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__2$', duration=5000)
...
class CableDelay_04(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__3$', duration=3000)
...
class CableDelay_05(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__4$', duration=3000)
...
class CableDelay_06(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__5$', duration=3000)
...
class CableDelay_04_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__6$', duration=1000)
...
class CableDelay_05_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__7$', duration=1000)
...
class CableDelay_06_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__8$', duration=1000)
...
class CableDelay_04_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__9$', duration=1000)
...
class CableDelay_05_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__10$', duration=1000)
...
class CableDelay_06_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__11$', duration=1000)
...
class CableDelay_04_4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__12$', duration=1000)
...
class CableDelay_05_4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__13$', duration=1000)
...
class CableDelay_06_4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__14$', duration=1000)
...
class CableDelay_04_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__15$', duration=5000)
...
class CableDelay_05_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__16$', duration=5000)
...
class CableDelay_06_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.Text, script='$02020310_BF__FIELD_1__17$', duration=5000)
