...
class CableDelay_01_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__3$', duration=3000)
...
class CableDelay_01_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__4$', duration=3000)
...
class CableDelay_01_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__5$', duration=3000)
...
class CableDelay_02_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__6$', duration=1000)
...
class CableDelay_02_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__7$', duration=1000)
...
class CableDelay_02_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__8$', duration=1000)
...
class CableDelay_03_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__9$', duration=1000)
...
class CableDelay_03_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__10$', duration=1000)
...
class CableDelay_03_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__11$', duration=1000)
...
class CableDelay_04_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__12$', duration=1000)
...
class CableDelay_04_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__13$', duration=1000)
...
class CableDelay_04_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__14$', duration=1000)
...
class CableDelay_05_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__15$', duration=5000)
...
class CableDelay_05_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__16$', duration=5000)
...
class CableDelay_05_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_event_ui_script(type=BannerType.GameOver, script='$02020310_BF__MAIN__17$', duration=5000)
