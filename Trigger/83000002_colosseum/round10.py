...
class 라운드조건체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_round() == 10:
            self.side_npc_talk(npc_id=11004288, illust='nagi_normal', script='$83000002_COLOSSEUM__ROUND10__0$', duration=5000)
        ...
        self.side_npc_talk(npc_id=11004288, illust='nagi_switchon', script='$83000002_COLOSSEUM__ROUND10__1$', duration=3000)
...
class 카운트(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_count_ui(text='$83000002_COLOSSEUM__ROUND10__2$', count=3, sound_type=2)
...
class 스폰대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=110, msg='$83000002_COLOSSEUM__ROUND10__3$', duration=3000)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[110]):
            self.add_balloon_talk(spawn_id=110, msg='$83000002_COLOSSEUM__ROUND10__4$', duration=3000)
        ...
        if self.time_expired(timer_id='LimitTimer'):
            ...
            self.side_npc_talk(npc_id=11004288, illust='nagi_switchon', script='$83000002_COLOSSEUM__ROUND10__5$', duration=3000)
        ...
        if self.user_detected(box_ids=[902]):
            ...
            self.side_npc_talk(npc_id=11004288, illust='nagi_switchon', script='$83000002_COLOSSEUM__ROUND10__6$', duration=3000)
            self.destroy_monster(spawn_ids=[110])
            self.set_npc_duel_hp_bar(spawn_id=110)
            self.destroy_monster(spawn_ids=[10000])
            self.destroy_monster(spawn_ids=[10001])
        ...
        if not self.user_detected(box_ids=[904]):
            ...
            self.side_npc_talk(npc_id=11004288, illust='nagi_switchon', script='$83000002_COLOSSEUM__ROUND10__7$', duration=3000)
            self.destroy_monster(spawn_ids=[110])
            self.set_npc_duel_hp_bar(spawn_id=110)
            self.destroy_monster(spawn_ids=[10000])
            self.destroy_monster(spawn_ids=[10001])
...
class ClearRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            ...
            self.set_event_ui_script(type=BannerType.Bonus, script='$83000002_COLOSSEUM__ROUND10__8$', duration=3000)
...
class FailRoundDelay(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.set_event_ui_script(type=BannerType.Success, script='$83000002_COLOSSEUM__ROUND10__9$', duration=3000)
            return FailRound(self.ctx)
...
class ClearRound(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            ...
            self.side_npc_talk(npc_id=11004288, illust='nagi_normal', script='$83000002_COLOSSEUM__ROUND10__10$', duration=3000)
