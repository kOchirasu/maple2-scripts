...
class ready_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000442_BF__MAIN__0$', time=2)
        self.set_dialogue(type=1, spawn_id=101, script='$02000442_BF__MAIN__1$', time=2, arg5=2)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=201, script='$02000442_BF__MAIN__2$', time=2, arg5=5)
        self.set_dialogue(type=1, spawn_id=202, script='$02000442_BF__MAIN__3$', time=2, arg5=4)
        self.set_dialogue(type=1, spawn_id=204, script='$02000442_BF__MAIN__4$', time=2, arg5=6)
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000442_BF__MAIN__5$', duration=3000)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000442_BF__MAIN__6$', time=2)
        self.set_dialogue(type=1, spawn_id=101, script='$02000442_BF__MAIN__16$', time=2, arg5=2)
...
class boss_leftTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=302, script='$02000442_BF__MAIN__7$', time=3)
        self.set_dialogue(type=1, spawn_id=302, script='$02000442_BF__MAIN__8$', time=2, arg5=3)
...
class boss_rightTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_npc(spawn_id=102, patrol_name='MS2PatrolData_2003')
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2003')
        self.set_dialogue(type=1, spawn_id=301, script='$02000442_BF__MAIN__9$', time=3)
...
class boss_leftTurn_b_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 난파가 될 시 멈출 블록들
        self.set_dialogue(type=1, spawn_id=305, script='$02000442_BF__MAIN__10$', time=3)
...
class Ending_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_onetime_effect(id=1, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.set_dialogue(type=1, spawn_id=104, script='$02000442_BF__MAIN__11$', time=2)
        self.set_dialogue(type=1, spawn_id=103, script='$02000442_BF__MAIN__12$', time=2, arg5=1)
...
class End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[7012])
        self.set_effect(trigger_ids=[7013])
        self.set_dialogue(type=1, spawn_id=104, script='$02000442_BF__MAIN__17$', time=2, arg5=2)
        self.set_dialogue(type=1, spawn_id=103, script='$02000442_BF__MAIN__13$', time=2, arg5=4)
        self.set_dialogue(type=1, spawn_id=104, script='$02000442_BF__MAIN__14$', time=2, arg5=7)
        self.set_dialogue(type=1, spawn_id=103, script='$02000442_BF__MAIN__15$', time=2, arg5=9)
