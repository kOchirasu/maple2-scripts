""" trigger/02020003_bf/118_melodypattern.xml """
import trigger_api
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11207], visible=True) # Bell D
        self.set_actor(trigger_id=11007, visible=True, initial_sequence='ks_quest_musical_B01_purple') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11007, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11208], visible=True) # Bell A
        self.set_actor(trigger_id=11008, visible=True, initial_sequence='ks_quest_musical_B01_pink') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11008, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell A
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000064], state=1) # Lever D
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000065], state=1) # Lever A
