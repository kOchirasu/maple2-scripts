...
class 축하2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=100, script='$52000007_QD__CONGRATULATION__0$')
        self.set_dialogue(type=1, spawn_id=101, script='$52000007_QD__CONGRATULATION__1$')
