...
class 몬스터출현01_1번생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__801$', duration=3000, box_ids=['0'])
...
class 첫번째힌트발견01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__800$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 구출안내01_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__802$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 추격연출종료01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__803$', duration=2000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 외다리스위치출현01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__804$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 다리건너갈준비01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__805$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 마지막웨이브알림01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__806$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 보스전투_시작01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__807$', duration=3000, box_ids=['0'])
        self.set_effect(trigger_ids=[7771], visible=True) # UI  메시지 알림 사운드
...
class 보스전투_끝01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000331_BF__Seeker01__808$', duration=3000, box_ids=['0'])
...
class 마지막연출_포털출현01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Success, script='$02000331_BF__Seeker01__809$', duration=3000, box_ids=['0'])
