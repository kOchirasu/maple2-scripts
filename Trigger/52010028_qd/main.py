...
class 이제가자(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010028_QD__MAIN__8$', duration=3000, box_ids='0')
...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010028_QD__MAIN__35$', duration=3000, box_ids='0')
...
class 전투메시지(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010028_QD__MAIN__23$', duration=3000, box_ids='0')
