""" trigger/02020141_bf/interactmesh10014112.xml """
import trigger_api
...
class 최초시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10003148], state=2)
...
class 탈것_등장연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[914112], auto_target=False)
...
class 탈것_등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10003148], state=1)
        self.destroy_monster(spawn_ids=[914112])

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10003148], state=0):
