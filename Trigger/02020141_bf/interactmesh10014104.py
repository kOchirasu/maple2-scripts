...
class 최초시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10003150], state=2)
...
class 탈것_등장연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[14104], auto_target=False)
...
class 탈것_등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(trigger_ids=[10003150], state=1)
        self.destroy_monster(spawn_ids=[14104])

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10003150], state=0):
