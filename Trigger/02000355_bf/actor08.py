""" trigger/02000355_bf/actor08.xml """
import trigger_api
...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=208, visible=True, initial_sequence='Damg_B')

    def on_tick(self) -> trigger_api.Trigger:
        if self.user_detected(box_ids=[1801]):
...
class 더미해제(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=208, initial_sequence='Damg_B')
...
class 리젠준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=208, visible=True, initial_sequence='Regen_A')
