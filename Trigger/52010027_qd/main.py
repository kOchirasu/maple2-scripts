...
class 차_전투1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010027_QD__MAIN__22$', duration=3000, box_ids='0')
...
class 차_전투2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010027_QD__MAIN__25$', duration=3000, box_ids='0')
...
class 페리온으로03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$52010027_QD__MAIN__55$', duration=3000, box_ids='0')
