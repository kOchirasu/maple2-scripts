...
class 목표(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02000532_BF__MAIN__2$', duration=3000)
...
class 문들어가기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.set_event_ui_script(type=BannerType.Text, script='$02000532_BF__MAIN__3$', duration=3000)
...
class 흑성회의반격(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.lock_my_pc()
        self.reset_camera(interpolation_time=1.0)
        self.set_event_ui_script(type=BannerType.Text, script='$02000532_BF__MAIN__15$', duration=3000)
...
class 엘리베이터안내(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000532_BF__MAIN__22$', duration=3000)
