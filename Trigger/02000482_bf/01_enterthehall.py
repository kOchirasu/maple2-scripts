...
class BlackeyeApp02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000482_BF__01_ENTERTHEHALL__0$', time=3, arg5=1)
...
class BlackeyeApp03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000482_BF__01_ENTERTHEHALL__1$', time=3)
...
class EnemyApp02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=901, script='$02000482_BF__01_ENTERTHEHALL__2$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=902, script='$02000482_BF__01_ENTERTHEHALL__3$', time=2, arg5=1)
        self.set_dialogue(type=1, spawn_id=903, script='$02000482_BF__01_ENTERTHEHALL__4$', time=2, arg5=1)
...
class BlackeyeAction01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000006, script='$02000482_BF__01_ENTERTHEHALL__5$', time=5) # 블랙아이
...
class BlackeyeAction02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__6$', time=3, arg5=1)
...
class MoveToUpstairs02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000006, script='$02000482_BF__01_ENTERTHEHALL__7$', time=5) # 블랙아이
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000482_BF__01_ENTERTHEHALL__8$', duration=4000, box_ids='0')
...
class NpcMonologue01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__9$', time=3)
...
class NpcMonologue02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__10$', time=3)
...
class NpcMonologue03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__11$', time=3)
...
class NpcMonologue04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__12$', time=3)
