...
class ToWall02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000482_BF__04_RANDOMPORTAL__0$', duration=2000, box_ids='0')
...
class ToRoom02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000482_BF__04_RANDOMPORTAL__2$', duration=2000, box_ids='0')
...
class ToTower02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000482_BF__04_RANDOMPORTAL__4$', duration=2000, box_ids='0')
