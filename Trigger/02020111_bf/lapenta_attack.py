...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=23501011, illust='Turned_Renduebian_normal', script='$02020111_BF__LAPENTA_ATTACK__0$', duration=3432, voice='ko/Npc/00002199')
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3432):
