...
class 조명변경(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02020111_BF__MOVEMENT_01__0$', duration=3000)
...
class 유저이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02020111_BF__MOVEMENT_01__2$', duration=4000)
