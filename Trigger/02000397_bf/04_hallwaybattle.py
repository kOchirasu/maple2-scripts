""" trigger/02000397_bf/04_hallwaybattle.xml """
import trigger_api
...
class MobTrapOn01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=901, script='$02000397_BF__04_HALLWAYBATTLE__0$', time=2)
        self.set_dialogue(type=1, spawn_id=902, script='$02000397_BF__04_HALLWAYBATTLE__1$', time=2)
        self.set_dialogue(type=1, spawn_id=903, script='$02000397_BF__04_HALLWAYBATTLE__2$', time=2)
