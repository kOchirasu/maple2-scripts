...
class 차전투시작_03_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$52010029_QD__MAIN__30$', duration=3000, box_ids=['0'])
...
class 차전투시작_04_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=2)
        self.reset_camera(interpolation_time=1.0)
        self.set_event_ui_script(type=BannerType.Text, script='$52010029_QD__MAIN__37$', duration=3000, box_ids=['0'])
...
class 차전투시작_02_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.set_event_ui_script(type=BannerType.Text, script='$52010029_QD__MAIN__40$', duration=3000, box_ids=['0'])
...
class 에바고르전투_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.set_event_ui_script(type=BannerType.Text, script='$52010029_QD__MAIN__69$', duration=3000, box_ids=['0'])
