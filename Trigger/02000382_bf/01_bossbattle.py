...
class Boss01Talk01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003068, script='$02000382_BF__01_BOSSBATTLE__0$', time=4) # 설눈이
...
class Boss01Talk02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003069, script='$02000382_BF__01_BOSSBATTLE__1$', time=5) # 에르다
...
class Boss02Talk01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003068, script='$02000382_BF__01_BOSSBATTLE__2$', time=3) # 설눈이
...
class Boss02Talk02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003069, script='$02000382_BF__01_BOSSBATTLE__3$', time=4) # 에르다
...
class Boss03Talk01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003068, script='$02000382_BF__01_BOSSBATTLE__4$', time=4) # 설눈이
...
class Boss03Talk02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11003069, script='$02000382_BF__01_BOSSBATTLE__5$', time=5) # 에르다
