""" trigger/02000471_bf/event_02.xml """
import trigger_api
...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002018], state=0):
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$02000471_BF__EVENT_02__0$', time=5)
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001956, script='$02000471_BF__EVENT_02__1$', time=5)
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$02000471_BF__EVENT_02__2$', time=5)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$02000471_BF__EVENT_02__3$', time=5)
...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=2040314, key='TimerStart', value=1)
        self.destroy_monster(spawn_ids=[199])
        ...
        self.reset_camera()
        # self.set_event_ui_script(type=BannerType.GameOver, script='$02000471_BF__EVENT_02__4$', duration=5000)
...
class scene_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000471_BF__EVENT_02__9$', duration=5000)
...
class scene_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=181, script='$02000471_BF__EVENT_02__5$', time=3, arg5=2)
        self.set_dialogue(type=1, spawn_id=182, script='$02000471_BF__EVENT_02__6$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=183, script='$02000471_BF__EVENT_02__7$', time=3, arg5=8)
        self.set_dialogue(type=1, spawn_id=184, script='$02000471_BF__EVENT_02__8$', time=3)
