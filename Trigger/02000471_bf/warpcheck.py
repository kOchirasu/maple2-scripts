...
class warp_1st(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000471_BF__WARPCHECK__0$', duration=5000, box_ids='0')
...
class warp_cancel(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000471_BF__WARPCHECK__1$', duration=5000, box_ids='0')
