...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=2040315, key='10002024clear', value=0)
        self.set_user_value(trigger_id=2040321, key='10002024clear', value=0)
        self.set_user_value(trigger_id=2040322, key='10002024clear', value=0)

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002024], state=0):
...
class Event_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=2040315, key='10002024clear', value=1)
        self.set_user_value(trigger_id=2040321, key='10002024clear', value=1)
        self.set_user_value(trigger_id=2040322, key='10002024clear', value=1)
...
class Event_06_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1103, script='$02000471_BF__MAGIC_06__0$', time=3, arg5=1)
        self.set_npc_emotion_sequence(spawn_id=1103, sequence_name='Talk_A')
        self.set_dialogue(type=1, spawn_id=1104, script='$02000471_BF__MAGIC_06__1$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=1103, script='$02000471_BF__MAGIC_06__2$', time=3, arg5=7)
        self.set_dialogue(type=1, spawn_id=1104, script='$02000471_BF__MAGIC_06__3$', time=3, arg5=10)
