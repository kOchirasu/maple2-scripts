...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001137], state=0) # ToWall_True
        self.set_interact_object(trigger_ids=[10001138], state=0) # ToRoom_True
        self.set_interact_object(trigger_ids=[10001139], state=0) # ToTower_True
...
class ToWall01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001137], state=1) # ToWall_True
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001137], state=0):
...
class ToWall02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$02000396_BF__04_RANDOMPORTAL__0$', duration=2000, box_ids=['0'])
...
class ToWallGuide01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000006, script='$02000396_BF__04_RANDOMPORTAL__1$', time=5) # 블랙아이
...
class ToRoom01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10001138], state=1) # ToRoom_True
        self.set_user_value(trigger_id=5, key='ToWallFalse', value=1) # ToWall_False
        self.set_user_value(trigger_id=7, key='ToTowerFalse', value=1) # ToTowerFalse

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001138], state=0):
            return ToRoom02(self.ctx)


class ToRoom02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000396_BF__04_RANDOMPORTAL__2$', duration=2000, box_ids=['0'])
...
class ToRoomGuide01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000006, script='$02000396_BF__04_RANDOMPORTAL__3$', time=5) # 블랙아이
...
class ToTower01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=5, key='ToWallFalse', value=1) # ToWall_False
        self.set_user_value(trigger_id=6, key='ToRoomFalse', value=1) # ToRoom_False
        self.set_interact_object(trigger_ids=[10001139], state=1) # ToTower_True

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001139], state=0):
            return ToTower02(self.ctx)


class ToTower02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='$02000396_BF__04_RANDOMPORTAL__4$', duration=2000, box_ids=['0'])
...
class ToTowerGuide01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000006, script='$02000396_BF__04_RANDOMPORTAL__5$', time=5) # 블랙아이
