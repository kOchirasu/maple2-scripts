...
class 초재기2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000243_BF__TIMER__0$', duration=3000, box_ids='0')
...
class 딜레이(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='99', seconds=3)
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000243_BF__TIMER__1$', duration=3000, box_ids='0')
...
class 초재기3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000243_BF__TIMER__2$', duration=5000, box_ids='0')
