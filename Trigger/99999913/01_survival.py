...
class Wait01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='잠시 기다려주세요.\\n잠시 후 경기 시작점이 결정됩니다.', duration=4000, box_ids=['0'])
...
class StartPositionRandomPick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='시작점으로 이동합니다.', duration=3000, box_ids=['0'])
...
class PVPReady(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='space 키를 누르면  수레에 탈 수 있습니다.\\nspace 키를 다시 누르면 수레에서 내립니다.', duration=3000, box_ids=['0'])
...
class PVPStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='경기를 곧 시작합니다!\\n경기 시작과 함께 수레가 출발합니다!', duration=4000, box_ids=['0'])
...
class GameCancel01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='참가자 부족으로 인해 경기를 취소합니다.', duration=4000, box_ids=['0'])
...
class GameCancel02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.Text, script='잠시 후 원래 있던 곳으로 돌아갑니다.', duration=4000, box_ids=['0'])
