""" trigger/02000403_bf/magic_05.xml """
import trigger_api


class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000035], state=0):
...
class Event_05_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=147, script='$02000403_BF__MAGIC_05__0$', time=2, arg5=2)
        self.set_dialogue(type=1, spawn_id=145, script='$02000403_BF__MAGIC_05__1$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=146, script='$02000403_BF__MAGIC_05__2$', time=3, arg5=5)
        self.set_dialogue(type=1, spawn_id=147, script='$02000403_BF__MAGIC_05__3$', time=3, arg5=6)
