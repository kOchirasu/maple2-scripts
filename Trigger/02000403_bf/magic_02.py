...
class idle(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000032], state=0):
...
class Event_02_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1122, script='$02000403_BF__MAGIC_02__0$', time=3)
        self.set_dialogue(type=1, spawn_id=1121, script='$02000403_BF__MAGIC_02__1$', time=3, arg5=3)
