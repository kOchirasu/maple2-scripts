...
class start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1110, script='$02000403_BF__EVENT_05__0$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=1111, script='$02000403_BF__EVENT_05__1$', time=3, arg5=5)
        self.set_dialogue(type=1, spawn_id=1112, script='$02000403_BF__EVENT_05__2$', time=3, arg5=1)
        self.set_dialogue(type=1, spawn_id=1113, script='$02000403_BF__EVENT_05__3$', time=3, arg5=2)
