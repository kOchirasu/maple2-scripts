""" trigger/02000378_bf/704_darknesstotem_04round.xml """
import trigger_api
...
class JuntaReady01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2304, script='$02000378_BF__704_DARKNESSTOTEM_04ROUND__0$', time=3) # 전투중인 준타
