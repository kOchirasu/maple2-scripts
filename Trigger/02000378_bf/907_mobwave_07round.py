...
class FirstWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__907_MOBWAVE_07ROUND__0$', duration=6000, box_ids='0')
...
class FirstWaveDirection10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90700,90702,90704], auto_target=False) # ,90706,90708
...
class FirstWaveDirection11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90701,90703,90705], auto_target=False) # ,90707,90709
...
class FirstWaveDirection20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90710,90712,90714], auto_target=False) # ,90716,90718
...
class FirstWaveDirection21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90711,90713,90715], auto_target=False) # ,90717,90719
...
class FirstWaveDirection30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90720,90722,90724], auto_target=False) # ,90726,90728
...
class FirstWaveDirection31(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90721,90723,90725], auto_target=False) # ,90727,90729
...
class FirstWaveDirection40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90730,90732,90734], auto_target=False) # ,90736,90738
...
class FirstWaveDirection41(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90731,90733,90735], auto_target=False) # ,90737,90739
...
class FirstWaveDirection50(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90740,90742,90744], auto_target=False) # ,90746,90748
...
class FirstWaveDirection51(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90741,90743,90745], auto_target=False) # ,90747,90749
...
class FifthWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[90790,90792,90794], auto_target=False) # ,90796,90798
...
class FifthWaveDelay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90791,90793,90795], auto_target=False) # ,90797,90799
...
class NpcDownPenaltyStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__907_MOBWAVE_07ROUND__1$', duration=4000, box_ids='0')
        self.set_dialogue(type=1, spawn_id=1107, script='$02000378_BF__907_MOBWAVE_07ROUND__2$', time=4, arg5=4) # 틴차이
...
class ReturnToWave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(key='PenaltyFinish', value=0)
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__907_MOBWAVE_07ROUND__3$', duration=4000, box_ids='0')
