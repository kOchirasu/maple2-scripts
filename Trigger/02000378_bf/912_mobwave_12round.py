...
class FirstWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__912_MOBWAVE_12ROUND__0$', duration=6000, box_ids='0')
        self.set_user_value(key='WaveTime', value=1) # 웨이브 진행 순서 기억
        self.set_effect(trigger_ids=[5112], visible=True) # 12Round_ShadowApp
        self.spawn_monster(spawn_ids=[91200,91202,91204], auto_target=False) # ,91206,91208
...
class FirstWaveDelayRandom(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91201,91203,91205], auto_target=False) # ,91207,91209
...
class SecondWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[91210,91212,91214], auto_target=False) # ,91216,91218
...
class SecondWaveDelayRandom(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91211,91213,91215], auto_target=False) # ,91217,91219
...
class ThirdWaveDirection10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91220,91222,91224], auto_target=False) # ,91226,91228
...
class ThirdWaveDirection11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91221,91223,91225], auto_target=False) # ,91227,91229
...
class ThirdWaveDirection20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91230,91232,91234], auto_target=False) # ,91236,91238
...
class ThirdWaveDirection21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91231,91233,91235], auto_target=False) # ,91237,91239
...
class ThirdWaveDirection30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91240,91242,91244], auto_target=False) # ,91246,91248
...
class ThirdWaveDirection31(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91241,91243,91245], auto_target=False) # ,91247,91249
...
class ThirdWaveDirection40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91250,91252,91254], auto_target=False) # ,91256,91258
...
class ThirdWaveDirection41(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91251,91253,91255], auto_target=False) # ,91257,91259
...
class ThirdWaveDirection50(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91260,91262,91264], auto_target=False) # ,91266,91268
...
class ThirdWaveDirection51(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91261,91263,91265], auto_target=False) # ,91267,91269
...
class ThirdWaveDirection60(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91270,91272,91274], auto_target=False) # ,91276,91278
...
class ThirdWaveDirection61(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91271,91273,91275], auto_target=False) # ,91277,91279
...
class FifthWaveDelayRandom(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.random_condition(weight=30.0):
            return FifthWaveDelay3000(self.ctx)
        if self.random_condition(weight=30.0):
...
"""
class FifthWaveDelay3000(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            return SixthWaveStart(self.ctx)
        if self.monster_dead(spawn_ids=[1012]): # 수호대상 틴차이
            return NpcDownPenaltyStart(self.ctx)
"""
...
class SeventhWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[91290,91292,91294], auto_target=False) # ,91296,91298
...
class SeventhWaveDelay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[91291,91293,91295], auto_target=False) # ,91297,91299
...
class NpcDownPenaltyStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__912_MOBWAVE_12ROUND__1$', duration=4000, box_ids='0')
        self.set_dialogue(type=1, spawn_id=1112, script='$02000378_BF__912_MOBWAVE_12ROUND__2$', time=4, arg5=4) # 틴차이
...
class ReturnToWave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(key='PenaltyFinish', value=0)
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__912_MOBWAVE_12ROUND__3$', duration=4000, box_ids='0')
