""" trigger/02000378_bf/905_mobwave_05round.xml """
import trigger_api
...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5105]) # 05Round_ShadowApp
...
class FirstWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__905_MOBWAVE_05ROUND__0$', duration=6000, box_ids='0')
        self.set_user_value(key='WaveTime', value=1) # 웨이브 진행 순서 기억
        self.set_effect(trigger_ids=[5105], visible=True) # 05Round_ShadowApp
...
class FirstWaveDirection10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90500,90502,90504], auto_target=False) # ,90506,90508
...
class FirstWaveDirection11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90501,90503,90505], auto_target=False) # ,90507,90509
...
class FirstWaveDirection20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90510,90512,90514], auto_target=False) # ,90516,90518
...
class FirstWaveDirection21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90511,90513,90515], auto_target=False) # ,90517,90519
...
class FirstWaveDirection30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90520,90522,90524], auto_target=False) # ,90526,90528
...
class FirstWaveDirection31(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90521,90523,90525], auto_target=False) # ,90527,90529
...
class FirstWaveDirection40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90530,90532,90534], auto_target=False) # ,90536,90538
...
class FirstWaveDirection41(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90531,90533,90535], auto_target=False) # ,90537,90539
...
class FirstWaveDirection50(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90540,90542,90544], auto_target=False) # ,90546,90548
...
class FirstWaveDirection51(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90541,90543,90545], auto_target=False) # ,90547,90549
...
class FifthWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[90590,90592,90594], auto_target=False) # ,90596,90598
...
class FifthWaveDelay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90591,90593,90595], auto_target=False) # ,90597,90599
...
class DefenceSucess02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5105]) # 05Round_ShadowApp
        self.set_user_value(trigger_id=5, key='05RoundSuccess', value=1)
...
class NpcDownPenaltyStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=805, key='PenaltyMob', value=1)
        self.destroy_monster(spawn_ids=[1005]) # 수호대상 틴차이
        self.spawn_monster(spawn_ids=[1105], auto_target=False) # 쓰러진 틴차이
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__905_MOBWAVE_05ROUND__1$', duration=4000, box_ids='0')
        self.set_dialogue(type=1, spawn_id=1105, script='$02000378_BF__905_MOBWAVE_05ROUND__2$', time=4, arg5=4) # 틴차이
...
class ReturnToWave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(key='PenaltyFinish', value=0)
        self.set_effect(trigger_ids=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000378_BF__905_MOBWAVE_05ROUND__3$', duration=4000, box_ids='0')
        self.destroy_monster(spawn_ids=[1105]) # 쓰러진 틴차이
        self.spawn_monster(spawn_ids=[1005], auto_target=False) # 수호대상 틴차이
        self.remove_balloon_talk(spawn_id=1105)
