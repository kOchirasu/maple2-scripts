""" trigger/02000378_bf/803_penalty_03round.xml """
import trigger_api
...
class FirstWaveStart01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90380,90382,90384,90386,90388], auto_target=False)
...
class FirstWaveStart02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90381,90383,90385,90387,90389], auto_target=False)
...
class SecondWaveStart02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[90391,90393,90395,90397,90399], auto_target=False)
