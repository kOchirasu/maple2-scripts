""" trigger/02000378_bf/712_darknesstotem_12round.xml """
import trigger_api
...
class JuntaReady01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2312, script='$02000378_BF__712_DARKNESSTOTEM_12ROUND__0$', time=3) # 전투중인 준타
