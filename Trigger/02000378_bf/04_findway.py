...
class ReadyToWalkIn_FromLeft03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000378_BF__04_FINDWAY__1$', time=2, arg5=2)
...
class ReadyToWalkIn_FromRight03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=103, script='$02000378_BF__04_FINDWAY__3$', time=2, arg5=2)
