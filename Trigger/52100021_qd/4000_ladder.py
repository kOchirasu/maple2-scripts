""" trigger/52100021_qd/4000_ladder.xml """
import trigger_api


class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_ladder(trigger_ids=[4001]) # Ladder_Shortcut
        self.set_ladder(trigger_ids=[4002]) # Ladder_Shortcut
        self.set_ladder(trigger_ids=[4003]) # Ladder_Shortcut
