...
class 보스_추가대사(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.set_event_ui(type=1, arg2='$02020065_BF__BATTLE_3__0$', arg3='5000')
...
class 보스_무적페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui(type=1, arg2='$02020065_BF__BATTLE_3__1$', arg3='5000')
        ...
        self.start_combine_spawn(group_id=[10000603], is_start=True)
        self.start_combine_spawn(group_id=[10000605], is_start=True)
        self.set_user_value(trigger_id=99990006, key='Battle_3_SpawnStart', value=1)
