...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4001]) # <kfm이 없는 크리티아스 나무 더미>
...
class 딜레이(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020065_BF__MAIN__0$', duration=5000)
...
class 방폭(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020065_BF__MAIN__1$', duration=10000)
...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020065_BF__MAIN__2$', duration=5000)
...
class 포탑페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02020065_BF__MAIN__3$', duration=5000)
...
class 보스페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__4$')
...
class 성공_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__5$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 성공_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11003533, illust='Bliche_smile', duration=5000, script='$02020065_BF__MAIN__6$')
...
class 실패_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__7$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 실패_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__MAIN__8$')
