""" trigger/52000026_qd/seperategroup_ranger.xml """
import trigger_api
...
class 대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.quest_user_detected(box_ids=[9000], quest_ids=[10002973], quest_states=[1], job_code=50):
            # 퀘스트 진행 중 상태
...
class 차입장03_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000601, script='$52000026_QD__SEPERATEGROUP_RANGER__0$', time=3)
...
class 차입장04_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_RANGER__1$', time=3) # 음성 코드 00001155
...
class 차입장06_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_RANGER__2$', time=4)
...
class 차입장03_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_RANGER__3$', time=7) # 음성 코드 00000553
...
class 차입장03_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000026_QD__SEPERATEGROUP_RANGER__4$', time=4)
...
class 차입장05_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_RANGER__5$', time=4)
...
class 차입장03_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001583, script='$52000026_QD__SEPERATEGROUP_RANGER__6$', time=3)
...
class 차입장05_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001584, script='$52000026_QD__SEPERATEGROUP_RANGER__7$', time=4)
...
class 차입장07_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_RANGER__8$', time=3)
...
class 차입장09_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_RANGER__9$', time=4)
...
class 차입장12_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001586, script='$52000026_QD__SEPERATEGROUP_RANGER__10$', time=3)
...
class 차입장14_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_RANGER__11$', time=3)
...
class 정렬01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_RANGER__12$', time=5) # 음성 코드 00001338
...
class 본론01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_RANGER__13$', time=10) # 음성 코드 00001339
...
class 본론03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_RANGER__14$', time=6) # 음성 코드 00001340
...
class 본론07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_RANGER__15$', time=5) # 음성 코드 00001292
...
class 정리01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_RANGER__16$', time=6) # 음성 코드 00001159
...
class 반대01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_RANGER__17$', time=4)
...
class 반대03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001586, script='$52000026_QD__SEPERATEGROUP_RANGER__18$', time=4)
...
class 반대06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001584, script='$52000026_QD__SEPERATEGROUP_RANGER__19$', time=4)
...
class 반대08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_RANGER__20$', time=5)
...
class 반대10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_RANGER__21$', time=4)
