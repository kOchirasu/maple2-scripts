""" trigger/02020030_bf/105_melodypattern.xml """
import trigger_api
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11205], visible=True) # Bell D
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_blue') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11005, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11206], visible=True) # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11207], visible=True) # Bell B
