""" trigger/02020030_bf/110_melodypattern.xml """
import trigger_api
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11201], visible=True) # Bell A
        self.set_actor(trigger_id=11001, visible=True, initial_sequence='ks_quest_musical_B01_red') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11001, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[11202], visible=True) # Bell B
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_orange') # Bell B
...
class MelodyPlay04_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11002, visible=True, initial_sequence='ks_quest_musical_B01_off') # Bell B
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000058], state=1) # Lever A
