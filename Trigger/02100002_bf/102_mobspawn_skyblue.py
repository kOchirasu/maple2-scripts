...
class Gauge100_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[20100], auto_target=False) # 100%
...
class Gauge75_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5102], visible=True)
        self.spawn_monster(spawn_ids=[20075], auto_target=False) # 75%
...
class Gauge50_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5102], visible=True)
        self.spawn_monster(spawn_ids=[20050], auto_target=False) # 50%
...
class Gauge25_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5102], visible=True)
        self.spawn_monster(spawn_ids=[20025], auto_target=False) # 25%
...
class Gauge1_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5102], visible=True)
        self.spawn_monster(spawn_ids=[20001], auto_target=False) # 1%
...
class Spawn_Eater(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[21001], auto_target=False)
...
class Spawn_Runner(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Abnormal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5202], visible=True)
        self.spawn_monster(spawn_ids=[21002], auto_target=False)
...
class Spawn_BigMom(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[21003], auto_target=False)
