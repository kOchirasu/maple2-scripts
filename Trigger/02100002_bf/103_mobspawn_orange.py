...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawn_ids=[30100,30075,30050,30025,30001,31001,31002,31003])
...
class Gauge100_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[30100], auto_target=False) # 100%
...
class Gauge75_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5103], visible=True)
        self.spawn_monster(spawn_ids=[30075], auto_target=False) # 75%
...
class Gauge50_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5103], visible=True)
        self.spawn_monster(spawn_ids=[30050], auto_target=False) # 50%
...
class Gauge25_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5103], visible=True)
        self.spawn_monster(spawn_ids=[30025], auto_target=False) # 25%
...
class Gauge1_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Normal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5103], visible=True)
        self.spawn_monster(spawn_ids=[30001], auto_target=False) # 1%
...
class Spawn_Eater(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[31001], auto_target=False)
...
class Spawn_Runner(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # Abnormal Slime Rebirth Sound
        self.set_effect(trigger_ids=[5203], visible=True)
        self.spawn_monster(spawn_ids=[31002], auto_target=False)
...
class Spawn_BigMom(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[31003], auto_target=False)
