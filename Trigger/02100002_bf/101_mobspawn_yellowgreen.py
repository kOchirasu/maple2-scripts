...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawn_ids=[10100,10075,10050,10025,10001,11001,11002,11003])
...
class Gauge100_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5101], visible=True) # Rebirth Sound
        self.spawn_monster(spawn_ids=[10100], auto_target=False) # 100%
...
class Gauge75_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5101], visible=True) # Rebirth Sound
        self.spawn_monster(spawn_ids=[10075], auto_target=False) # 75%
...
class Gauge50_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5101], visible=True) # Rebirth Sound
        self.spawn_monster(spawn_ids=[10050], auto_target=False) # 50%
...
class Gauge25_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5101], visible=True) # Rebirth Sound
        self.spawn_monster(spawn_ids=[10025], auto_target=False) # 25%
...
class Gauge1_Normal(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5101], visible=True) # Rebirth Sound
        self.spawn_monster(spawn_ids=[10001], auto_target=False) # 1%
