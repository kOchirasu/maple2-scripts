""" trigger/02100002_bf/12_tankrefil_skyblue.xml """
import trigger_api
...
class Gauge100(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.detect_liftable_object(box_ids=[2002], item_id=30000885):
            # 같은색 물감통이면
...
class Gauge100_Refil(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5302], visible=True) # Paint_Add_Sound
        self.set_effect(trigger_ids=[5402], visible=True) # Tank_Fill_Under_Sound
        self.set_effect(trigger_ids=[5502], visible=True) # Tank_Fill_Above_Sound
...
class Gauge1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.reset_timer(timer_id='10025')
        self.set_user_value(trigger_id=102, key='Gauge', value=1)
        self.set_actor(trigger_id=4002, visible=True, initial_sequence='Interaction_tankskyblue_A01_1') # Up
        self.set_actor(trigger_id=4102, visible=True, initial_sequence='Interaction_tankskyblue_A01_1') # Down
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=102, key='StopSpawn', value=1)
