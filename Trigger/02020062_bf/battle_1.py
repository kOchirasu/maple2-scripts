...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(group_id=[490])
        self.start_combine_spawn(group_id=[491])
        self.start_combine_spawn(group_id=[492])
        self.start_combine_spawn(group_id=[493])
        self.start_combine_spawn(group_id=[495])
...
class 스폰_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020062_BF__BATTLE_1__0$')
...
class 스폰_1_추가대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020062_BF__BATTLE_1__1$')
...
class 스폰_1_추가대사2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020062_BF__BATTLE_1__2$')

    def on_tick(self) -> trigger_api.Trigger:
        if self.shadow_expedition_points() >= 120:
...
class 스폰_5(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.shadow_expedition_points() >= 750:
