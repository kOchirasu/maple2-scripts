""" trigger/84000012_wd/84000012_main.xml """
import trigger_api
...
class 연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.wedding_move_user(entry_type='Guest', map_id=84000012, portal_ids=[22,23], box_id=701)
        # 701번 박스(버진로드)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entry_type='Guest', map_id=84000012, portal_ids=[22,23], box_id=703)
        self.wedding_move_user(entry_type='Groom', map_id=84000012, portal_ids=[11], box_id=702) # 신랑 11번으로
        self.wedding_move_user(entry_type='Bride', map_id=84000012, portal_ids=[12], box_id=702) # 신부는 12번으로
...
class 주례줌인02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__0$', duration=3500)
...
class 주례사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=3)
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__1$', duration=4000)
...
class 탈주로중단(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__2$', duration=3000)
...
class 탈주로중단선언(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__3$', duration=3000)
...
class 미입력으로중단01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__4$', duration=3000)
...
class 미입력으로중단선언(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__5$', duration=3000)
...
class 성혼발표(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004723, msg='$84000012_WD__84000012_MAIN__6$', duration=2500)
