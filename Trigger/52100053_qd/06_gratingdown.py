...
class Setting(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10002104], state=0) # Lever_BlockStart
        self.set_interact_object(trigger_ids=[10002105], state=0) # Lever_BlockOff
...
class BlockEnable(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10002104], state=1) # Lever_BlockStart

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002104], state=0):
...
class BlockDisable(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(trigger_ids=[10002105], state=1) # Lever_BlockOff

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002105], state=0):
