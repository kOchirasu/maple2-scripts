...
class 전투시작03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(npc_id=11003536, illust='infernog_nomal', duration=8900, script='$02000410_BF__PopUpCinema__2$', voice='ko/Monster/60000724')

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=8900):
