...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_portal(portal_id=2)
        self.set_effect(trigger_ids=[8000], visible=True)
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__0$', duration=3000)
...
class 첫번째오브젝트조사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__5$', duration=3000)
...
class 첫번째불켰음(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__6$', duration=3000)
...
class 두번째오브젝트조사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__9$', duration=3000)
...
class 세번째전투판체크(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__10$', duration=3000)
...
class 세번째오브젝트조사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__13$', duration=3000)
...
class 네번째전투판체크(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__14$', duration=3000)
...
class 네번째오브젝트조사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__16$', duration=3000)
...
class 보스전투판완성시키기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$02000540_BF__MAIN__17$', duration=3000)
