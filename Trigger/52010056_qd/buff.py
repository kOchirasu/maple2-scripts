...
class Buff_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[2001], skill_id=99910300, level=1, ignore_player=False) # 트리스탄 변신
        self.add_buff(box_ids=[2001], skill_id=99910300, level=1, ignore_player=False, is_skill_set=False) # 트리스탄 변신
...
class Buff_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[2001], skill_id=99910330, level=1, ignore_player=False) # 트리스탄 변신
        self.add_buff(box_ids=[2001], skill_id=99910330, level=1, ignore_player=False, is_skill_set=False) # 트리스탄 변신
