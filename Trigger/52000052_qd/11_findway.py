...
class Round11_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1011, script='$52000052_QD__04_FINDWAY__2$', time=3, arg5=2) # 틴차이
...
class Round11_Sucess(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=111, script='$52000052_QD__04_FINDWAY__3$', time=2, arg5=1) # 틴차이
