...
class MovingDelay01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.spawn_monster(spawn_ids=[907,908,909], auto_target=False) # 레이저 토템
        pass
...
class ReadyToWalkIn01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=212, script='$52000052_QD__12_FINDWAY__0$', time=3, arg5=1) # 준타
...
class ReadyToWalkIn02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=112, script='$52000052_QD__12_FINDWAY__1$', time=3, arg5=1) # 틴차이
...
class Round12_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1012, script='$52000052_QD__12_FINDWAY__2$', time=3, arg5=2) # 틴차이
...
class Round12_RouteSelect(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=113, script='$52000052_QD__12_FINDWAY__3$', time=3) # 틴차이
...
class Round12_RouteApp01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.destroy_monster(spawn_ids=[907,908,909]) # 레이저 토템
