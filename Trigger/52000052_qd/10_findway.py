...
class ReadyToWalkIn_FromRight01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=208, script='$52000052_QD__04_FINDWAY__0$', time=2) # 준타
...
class ReadyToWalkIn_FromRight03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=108, script='$52000052_QD__04_FINDWAY__1$', time=2, arg5=2) # 틴차이
...
class Round10_Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1010, script='$52000052_QD__04_FINDWAY__2$', time=3, arg5=2) # 틴차이
...
class Round10_Sucess01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=110, script='$52000052_QD__04_FINDWAY__3$', time=2, arg5=1) # 틴차이
