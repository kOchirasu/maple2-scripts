...
class 시작멘트2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__3$', duration=4000)
...
class 시작멘트3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Text, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__4$', duration=4000)
...
class 보상단계(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Bonus, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__16$', duration=5000, box_ids=['303','304','305','306'])
        # 트로피 / 1=타겟박스 id, 2=achieveType, 3=code에 들어갈 값
...
class 버프걸기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_event_ui_script(type=BannerType.Bonus, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__18$', duration=5000, box_ids=['303','304','305','306'])
...
class 돈벼락(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Winner, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__19$', duration=5000, box_ids=['301'])
        self.set_event_ui_script(type=BannerType.Bonus, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__20$', duration=5000, box_ids=['303','304','305','306'])
