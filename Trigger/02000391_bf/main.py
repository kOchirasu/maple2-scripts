...
class 부선장대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__0$', time=3)
...
class 해적이동01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2099, script='$02000391_BF__MAIN__1$', time=3)
...
class 부선장대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__2$', time=3)
...
class 세이렌대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=24003010, script='$02000391_BF__MAIN__3$', time=3)
...
class 카메라310(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1099, script='$02000391_BF__MAIN__4$', time=3)
...
class 카메라304(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2099, script='$02000391_BF__MAIN__5$', time=3)
...
class 세이렌연주02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1098, script='$02000391_BF__MAIN__6$', time=3)
        self.play_system_sound_in_box(sound='Dungeon_Siren_Harp01')
        self.set_npc_emotion_sequence(spawn_id=1098, sequence_name='Attack_01_D')
...
class 세이렌이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1098, script='$02000391_BF__MAIN__7$', time=3)
...
class 카메라307(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__8$', time=3)
...
class 카메라308(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=2100, script='$02000391_BF__MAIN__9$', time=3)
