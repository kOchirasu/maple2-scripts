...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002072], state=0):
...
class Event_01_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=161, script='$52100041_QD__MAGIC_01__0$', time=3, arg5=2)
        self.set_dialogue(type=1, spawn_id=162, script='$52100041_QD__MAGIC_01__1$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=163, script='$52100041_QD__MAGIC_01__2$', time=3, arg5=6)
