""" trigger/52100041_qd/magic_06.xml """
import trigger_api


class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002077], state=0):
...
class Event_06_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1103, script='$52100041_QD__MAGIC_06__0$', time=3, arg5=1)
        self.set_npc_emotion_sequence(spawn_id=1103, sequence_name='Talk_A')
        self.set_dialogue(type=1, spawn_id=1104, script='$52100041_QD__MAGIC_06__1$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=1103, script='$52100041_QD__MAGIC_06__2$', time=3, arg5=7)
        self.set_dialogue(type=1, spawn_id=1104, script='$52100041_QD__MAGIC_06__3$', time=3, arg5=10)
...
class Event_06_h(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1107, script='$52100041_QD__MAGIC_06__4$', time=5)
        self.set_dialogue(type=1, spawn_id=1108, script='$52100041_QD__MAGIC_06__5$', time=3, arg5=3)
...
class Event_06_i(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1107, script='$52100041_QD__MAGIC_06__6$', time=5)
        self.set_dialogue(type=1, spawn_id=1108, script='$52100041_QD__MAGIC_06__7$', time=3, arg5=3)
        self.set_dialogue(type=1, spawn_id=1107, script='$52100041_QD__MAGIC_06__8$', time=3, arg5=5)
