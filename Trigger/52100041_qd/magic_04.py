...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002075], state=0):
...
class Event_04_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=144, script='$52100041_QD__MAGIC_04__0$', time=2, arg5=2)
        self.set_dialogue(type=1, spawn_id=144, script='$52100041_QD__MAGIC_04__1$', time=4, arg5=5)
...
class Event_04_c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=144, script='$52100041_QD__MAGIC_04__2$', time=3, arg5=1)
        self.set_dialogue(type=1, spawn_id=144, script='$52100041_QD__MAGIC_04__3$', time=3, arg5=4)
