...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002071], state=0):
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$52100041_QD__EVENT_02__0$', time=5)
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_skip(state=scene_06_ready)
        self.set_dialogue(type=2, spawn_id=11001956, script='$52100041_QD__EVENT_02__1$', time=5)
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$52100041_QD__EVENT_02__2$', time=5)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001956, script='$52100041_QD__EVENT_02__3$', time=5)
...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.shadow_expedition_open_boss_gauge(title='$52100041_QD__EVENT_02__4$', max_gauge_point=1000) # 진행 바 표기
        self.destroy_monster(spawn_ids=[199])
        ...
        self.reset_camera()
        self.set_event_ui_script(type=BannerType.Text, script='$02000403_BF__EVENT_02__4$', duration=3000)
...
class scene_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=181, script='$52100041_QD__EVENT_02__5$', time=3, arg5=2)
        self.set_dialogue(type=1, spawn_id=182, script='$52100041_QD__EVENT_02__6$', time=3, arg5=4)
        self.set_dialogue(type=1, spawn_id=183, script='$52100041_QD__EVENT_02__7$', time=3, arg5=8)
        self.set_dialogue(type=1, spawn_id=184, script='$52100041_QD__EVENT_02__8$', time=3)
