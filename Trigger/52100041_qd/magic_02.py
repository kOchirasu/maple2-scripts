""" trigger/52100041_qd/magic_02.xml """
import trigger_api
...
class idle(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10002073], state=0):
...
class Event_02_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1122, script='$52100041_QD__MAGIC_02__0$', time=3)
        self.set_dialogue(type=1, spawn_id=1121, script='$52100041_QD__MAGIC_02__1$', time=3, arg5=3)
