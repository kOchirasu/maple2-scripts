...
class 타이머시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='102', seconds=180, auto_remove=True, display=True)
...
class 생성_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='아크레온이 거대해지며 모든공격을 튕겨내기 시작했습니다.', duration=4000)
