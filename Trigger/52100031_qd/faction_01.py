...
class 석궁준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1001, script='$52100031_QD__FACTION_01__0$', time=5)
...
class 종료체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2901]):
            ...
            self.set_dialogue(type=1, spawn_id=1001, script='$52100031_QD__FACTION_01__2$', time=5)
            self.remove_buff(box_id=199, skill_id=99910150)
