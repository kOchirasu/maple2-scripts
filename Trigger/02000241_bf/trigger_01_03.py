...
class 버튼눌림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[603,604], auto_target=False)
        self.move_npc(spawn_id=603, patrol_name='MS2PatrolData_603')
        self.move_npc(spawn_id=604, patrol_name='MS2PatrolData_604')
