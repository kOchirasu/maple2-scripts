""" trigger/82000003_survival/01_survival.xml """
import trigger_api
...
class ReadyToKickOut(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_event_ui_script(type=BannerType.GameOver, script='$82000002_survival__01_SURVIVAL__13$', duration=4000, box_ids='0') # 잠시 후 원래 있던 곳으로 돌아갑니다.
