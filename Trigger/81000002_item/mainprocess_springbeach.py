...
class 경기장입장(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        self.move_to_portal(portal_id=902, box_id=302)
...
class 시작멘트2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__3$', duration=5500)
...
class 시작멘트3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.GameOver, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__4$', duration=5500)
...
class 한숨돌리기01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.end_mini_game_round(winner_box_id=301, exp_rate=0.2, game_name='UserMassive_Springbeach')
...
class 우승자카메라연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui_script(type=BannerType.Draw, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__16$', duration=5000, box_ids='303,304,305,306')

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=6000):
            self.set_local_camera(camera_id=9001)
...
class 보상단계(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_event_ui_script(type=BannerType.Draw, script='$61000007_ME__MAINPROCESS_SPRINGBEACH__18$', duration=5000, box_ids='303,304,305,306')
        ...
        self.mini_game_give_reward(winner_box_id=301, content_type='UserOpenMiniGameExtraReward') # 1일 5회 추가 보너스
        self.end_mini_game(winner_box_id=301, game_name='UserMassive_Springbeach')
...
class 모두탈락(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.end_mini_game_round(winner_box_id=301, game_name='UserMassive_Springbeach')
        self.end_mini_game(winner_box_id=301, game_name='UserMassive_Springbeach')
